...
KilledPlayer::KilledPlayer(::worker::EntityId killed)
: _killed{killed} {}

KilledPlayer KilledPlayer::Create() {
  return {
      0};
}
...
::worker::EntityId KilledPlayer::killed() const {
  return _killed;
}

::worker::EntityId& KilledPlayer::killed() {
  return _killed;
}

KilledPlayer& KilledPlayer::set_killed(::worker::EntityId value) {
  _killed = value;
  return *this;
}
...
void Write_KilledPlayer(
    const ::automaton::player::KilledPlayer& data, ::Pbio_Object* object) {
  ::Pbio_AddInt64(object, 1, data.killed());
}

::automaton::player::KilledPlayer Read_KilledPlayer(::Pbio_Object* object) {
  auto _killed = ::Pbio_GetInt64(object, 1);
  return {
      std::move(_killed)};
}
