...
namespace detail {
IMPROBABLE_DLL_API const ::worker::detail::ClientComponentVtable& Vtable_EntityAcl();
struct IMPROBABLE_DLL_API GenericCommandObject_EntityAcl {
  std::uint32_t CommandId;
  ::worker::Variant<> CommandObject;
};
IMPROBABLE_DLL_API const ::worker::detail::ClientComponentVtable& Vtable_Metadata();
struct IMPROBABLE_DLL_API GenericCommandObject_Metadata {
  std::uint32_t CommandId;
  ::worker::Variant<> CommandObject;
};
IMPROBABLE_DLL_API const ::worker::detail::ClientComponentVtable& Vtable_Position();
struct IMPROBABLE_DLL_API GenericCommandObject_Position {
  std::uint32_t CommandId;
  ::worker::Variant<> CommandObject;
};
IMPROBABLE_DLL_API const ::worker::detail::ClientComponentVtable& Vtable_Persistence();
...
public:
	WorkerAttributeSet() : _attribute() {}
  // Main constructor.
  WorkerAttributeSet(const ::worker::List< std::string >& attribute);
  // Creates a new instance with default values for each field.
  static WorkerAttributeSet Create();
 ...
 */
struct IMPROBABLE_DLL_API EntityAcl : ::worker::detail::ComponentMetaclassBase<
 ...
 */
struct IMPROBABLE_DLL_API Metadata : ::worker::detail::ComponentMetaclassBase<
 ...
 */
struct IMPROBABLE_DLL_API Position : ::worker::detail::ComponentMetaclassBase<
 ...
 */
struct IMPROBABLE_DLL_API Persistence : ::worker::detail::ComponentMetaclassBase<
